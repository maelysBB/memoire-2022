...
df = pd.read_csv(f"./csv_files/{distance}/drinking_water_cleaned_{distance}.csv")
helpers.bulk(es, doc_generator(), chunk_size=250, request_timeout= 200, raise_on_error=False)